...
{ path : 'adminconnect', loadChildren: () => import('./adminconnect/adminconnect.module').then(m => m.AdminconnectModule), canActivate: [AuthGuard] } , 
...
{ path : 'updatedelsaleforce', loadChildren: () => import('./updatedelsaleforce/updatedelsaleforce.module').then(m => m.UpdatedelsaleforceModule), canActivate: [AuthGuard] } , 
];
